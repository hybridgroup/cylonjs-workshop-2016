...
```
npm install cylon cylon-intel-iot cylon-gpio cylon-i2c cylon-api-http
```

Please note that the npm install must be run on the Intel Edison itself.

## Running the code
When you run any of these examples, you need to execute the command on the Intel Edison itself, not on your own computer.
